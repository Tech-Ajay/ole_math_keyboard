...
import 'package:ole_math_keyboard/src/custom_key_icons/custom_key_icons.dart';
import 'package:ole_math_keyboard/src/foundation/keyboard_button.dart';
import 'package:ole_math_keyboard/src/foundation/node.dart';
import 'package:ole_math_keyboard/src/widgets/decimal_separator.dart';
import 'package:ole_math_keyboard/src/widgets/keyboard_button.dart';
import 'package:ole_math_keyboard/src/widgets/math_field.dart';
import 'package:ole_math_keyboard/src/widgets/view_insets.dart';
import 'package:ole_math_keyboard/theme/theme.dart';
    ...
    return SizedBox(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          if (widget.controller.secondPage == 1)
            layout = widget.page1 ?? numberKeyboard;
          if (widget.controller.secondPage == 2)
            layout = widget.page2 ?? numberKeyboard;
          if (widget.controller.secondPage == 3)
            layout = widget.page3 ?? numberKeyboard;
          if (widget.controller.secondPage == 4)
            layout = widget.page4 ?? numberKeyboard;
          if (widget.controller.secondPage == 5)
            layout = widget.page5 ?? numberKeyboard;
          if (widget.controller.secondPage == 6)
            layout = widget.page6 ?? numberKeyboard;
                      ...
                      for (final config in row)
                        if (config is BasicKeyboardButtonConfig)
                          ...
                          _NavigationButton(
                            ...
                            iconSize: 22,
                            onTap: () =>
                                widget.controller.goBack(deleteMode: true),
                          )
